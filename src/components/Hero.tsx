    ...
    <>
      ...
      <section id="hero" className="p-6">
        <div className="lg:max-w-[1920px] lg:h-[450px]">
          <div className="flex flex-col space-y-10 lg:items-left lg:ml-[140px]">
            <h2 className="text-3xl font-bold text-white ml-5 mt-10 lg:mt-[68px] lg:text-5xl lg:mb-[60px] md:mb-[45px]">
            ...
            {/* <!-- square dots --> */}
            <div className="flex space-x-2 items-center mt-10 ml-6 md:mt-[33px]">
