...
function Solutions(): JSX.Element {
  ...
  function handleClick(toggleStatus: boolean, solution: string): void {
    ...
    document.getElementById('byType')?.classList.remove('border-b-4')
  }
        ...
        <div>
          ...
          <div className='mb-[24px] sm:flex sm:space-x-12'>
            ...
            <button
              ...
              className={`lg:px-[84px] lg:py-[19px] lg:w-[260px] lg:h-[60px] lg:m-[16px] font-bold text-[#4D4D4D] border-b-4 border-[#0000cc]  ${
